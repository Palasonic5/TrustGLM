...
class PubmedSemiDataset(Dataset):
    def __init__(self,):
        ...
        feature_path = '/scratch/qz2086/hard-label-attack/graphprompter/dataset/pubmed/GIA.emb'
    ...
    def processed_file_names(self) -> str:
        return ['/scratch/qz2086/hard-label-attack/graphprompter/dataset/pubmed/processed_data.pt']

    def get_idx_split(self):
        np_filename = f'/scratch/qz2086/hard-label-attack/graphprompter/dataset/split/semi_pubmed.npy'
        ...
        sup_np_filename = f'/scratch/qz2086/hard-label-attack/graphprompter/dataset/split/sup_pubmed.npy'
...
class PubmedSupDataset(Dataset):
    ...
    def get_idx_split(self):
        np_filename = f'/scratch/qz2086/hard-label-attack/graphprompter/dataset/split/sup_pubmed.npy'
        loaded_data_dict = np.load(np_filename, allow_pickle=True).item()
        # Convert the numpy arrays or non-Python int types to standard Python lists of int
        train_ids = [int(i) for i in loaded_data_dict['train']]
        test_ids = [int(i) for i in loaded_data_dict['test']]
