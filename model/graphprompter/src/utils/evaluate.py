...
eval_funcs = {
    ...
    'cora_sup_nettack': get_accuracy_cora,
    'cora_sup_metattack': get_accuracy_cora,
    'cora_sup_shuffle': get_accuracy_cora,
    'cora_sup_ln50': get_accuracy_cora,
    'cora_sup_ln100': get_accuracy_cora,
    'cora_sup_st': get_accuracy_cora,
    'cora_sup_prbcd_g': get_accuracy_cora,
    'cora_sup_prbcd_l': get_accuracy_cora,
    'cora_sup_lnc50': get_accuracy_cora,
    'cora_sup_lnc100': get_accuracy_cora,
    "cora_sup_lnt": get_accuracy_cora,
    'cora_sup_clnt': get_accuracy_cora,
    'citeseer': get_accuracy_citeseer,
    'pubmed_sup': get_accuracy_pubmed,
    'pubmed_sup_nettack': get_accuracy_pubmed,
    'pubmed_sup_metattack': get_accuracy_pubmed,
    'pubmed_sup_shuffle': get_accuracy_pubmed,
    'pubmed_sup_ln50': get_accuracy_pubmed,
    'pubmed_sup_ln100': get_accuracy_pubmed,
    'pubmed_sup_prbcd_g': get_accuracy_pubmed,
    'pubmed_sup_st': get_accuracy_pubmed,
    'pubmed_sup_prbcd_l': get_accuracy_pubmed,
    'pubmed_sup_lnc50': get_accuracy_pubmed,
    'pubmed_sup_lnc100': get_accuracy_pubmed,
    "pubmed_sup_lnt": get_accuracy_pubmed,
    'pubmed_sup_clnt': get_accuracy_pubmed,
    'arxiv_sup': get_accuracy_arxiv,
    'arxiv_sup_shuffle': get_accuracy_arxiv,
    'arxiv_sup_prbcd_g': get_accuracy_arxiv,
    'arxiv_sup_prbcd_l': get_accuracy_arxiv,
    'products_sup': get_accuracy_products,
    'products_sup_nettack': get_accuracy_products,
    "products_sup_shuffle": get_accuracy_products,
    'products_sup_ln50': get_accuracy_products,
    'products_sup_ln100': get_accuracy_products,
    'products_sup_prbcd_g': get_accuracy_products,
    'products_sup_st': get_accuracy_products,
    'products_sup_prbcd_l': get_accuracy_products,
    'products_sup_lnc50': get_accuracy_products,
    'products_sup_lnc100': get_accuracy_products,
    "products_sup_lnt": get_accuracy_products,
    "products_sup_clnt": get_accuracy_products,
    'cora_semi': get_accuracy_cora,
    'cora_semi_nettack': get_accuracy_cora,
    'cora_semi_metattack': get_accuracy_cora,
    'pubmed_semi': get_accuracy_pubmed,
    'pubmed_semi_nettack': get_accuracy_pubmed,
    'pubmed_semi_metattack': get_accuracy_pubmed,
    'arxiv_semi': get_accuracy_arxiv,
    'products_semi': get_accuracy_products,
    'products_semi_nettack': get_accuracy_products,
    "sports_semi": get_accuracy_sports,
    "sports_sup": get_accuracy_sports,
    "sports_sup_shuffle": get_accuracy_sports,
    'sports_sup_ln50': get_accuracy_sports,
    'sports_sup_ln100': get_accuracy_sports,
    'sports_sup_st': get_accuracy_sports,
    'sports_sup_lnc50': get_accuracy_sports,
    'sports_sup_lnc100': get_accuracy_sports,
    "sports_sup_lnt": get_accuracy_sports,
    "sports_sup_clnt": get_accuracy_sports,
    "computers_semi": get_accuracy_computers,
    "computers_sup": get_accuracy_computers,
    "computers_sup_shuffle": get_accuracy_computers,
    'computers_sup_ln50': get_accuracy_computers,
    'computers_sup_ln100': get_accuracy_computers,
    'computers_sup_st': get_accuracy_computers,
    'computers_sup_lnc50': get_accuracy_computers,
    'computers_sup_lnc100': get_accuracy_computers,
    "computers_sup_lnt": get_accuracy_computers,
    "computers_sup_clnt": get_accuracy_computers,
