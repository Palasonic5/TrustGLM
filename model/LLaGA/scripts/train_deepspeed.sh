...
--bf16 True \
--output_dir  /scratch/xs2334/TrustGLM/Baselines/LLaGA/checkpoints/semi-ind/${dataset}/${prefix}_${task} \
--num_train_epochs 1 \
...
--mm_use_graph_patch_token False \
--bf16 True \
--output_dir  /scratch/xs2334/TrustGLM/Baselines/LLaGA/checkpoints/semi-ind/${prefix}_${task} \
--num_train_epochs 1 \
--per_device_train_batch_size ${bs} \
--per_device_eval_batch_size 4 \
--gradient_accumulation_steps 1 \
