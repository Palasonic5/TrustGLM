...
@registry.register_model("translator_products_chatglm")
class TranslatorCHATGLMProducts(TranslatorBase):
    ...
    def forward(self, samples):
        ...
        text = samples[2]
        pre_instruction = ['The description of the product and its co-purchased products is as follows:' for _ in range(len(text))]
        instruction = ['\nQuestion: Please summarize the description of the product and its co-purchased products in English. Answer:' for _ in range(len(text))]
