...
def calc_sim(text_ls, new_texts, idx, sim_score_window, sim_predictor):
    ...
    # print('line 317 semantic sims', semantic_sims)
...
def mutate(rand_idx, text_ls, pos_ls, batch, new_attack, best_attack, remaining_indices,
    ...
    if orig_word == 0:
        ...
        print('line 456 pr in mutate', pr, flush = True)
...
def crossover(batch, population_size, population, parent1_idx, parent2_idx,
    ...
    for i in range(population_size-1):
        ...
        # print('line 448 p1', len(p1.split()))
        # print(len(p2.split()))
        # print(p1)
        # print(p2)
...
def attack(fuzz_val, top_k_words, qrs, sample_index, batch, true_label,
    ...
    # print('line 483 text ls', text_ls)
    ...
    if true_label != orig_label:
        ...
        if flag == 1:
            ...
            while True:
                ...
                print('choices line 684', choices, flush = True)
                if len(choices) > 0:
                    ...
                    for i in range(len(choices)):
                        ...
                        qrs+=1
                        if pr[0] == 0:
                            print('line 694', flush = True)
                            break
                        random_text[choices[i][0]] = text_ls[choices[i][0]]

                if len(choices) == 0:
                    print('line 699', flush = True)
                    break
            ...
            # print('line 619 text ls', text_ls)
            ...
            # print('line 631 mutate text ls', text_ls)
            ...
            for _ in range(max_iters):
                ...
                # print('line 721 parent 1 idx', parent1_idx)
                # print(parent2_idx)
